...
function Display(){
 ...
 console.log(current_hours)
    if( wakeup_value == current_hours){
        ...
        document.getElementById('img').style.backgroundImage="url(https://thumbs.dreamstime.com/z/time-to-wake-up-hand-writes-blackboard-49662247.jpg)"
...
if(lunch_value == current_hours){
    document.getElementById("img").style.backgroundImage="url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAkTKkKV-J5cblPCxkspcrcuESxdMxU2l7Tg&usqp=CAU)"
...
if(night_value == current_hours){
    document.getElementById("img").style.backgroundImage="url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuYCbcSTD7Z01YnzPnm8AoEo3AUw81O3E4Zw&usqp=CAU)"
